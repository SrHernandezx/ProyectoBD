...
public class IniSesMaes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(415, 306));
        ...
        jTextField2.setBackground(new java.awt.Color(105, 180, 255));
        ...
        jButton3.setBackground(new java.awt.Color(105, 180, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IniSesMaes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IniSesMaes().setVisible(true);
            }
        });
    }
